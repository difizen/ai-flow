        ...
        render: ({ queryString, isSelected, onSelect, onSetHighlight }) => {
          return (
            <VariableMenuItem
              title={item.value}
              icon={
                <AndroidFilled className="w-[14px] h-[14px] text-[#2970FF]" />
              }
      ...
      render: ({ queryString, isSelected, onSelect, onSetHighlight }) => {
        return (
          <VariableMenuItem
            title={'添加新变量'}
            icon={
              <AndroidFilled className="mr-2 w-[14px] h-[14px] text-[#2970FF]" />
            }
            queryString={queryString}
            isSelected={isSelected}
            onClick={onSelect}
      ...
      render: ({ queryString, isSelected, onSelect, onSetHighlight }) => {
        return (
          <VariableMenuItem
            title={'添加工具'}
            icon={
              <AndroidFilled className="mr-2 w-[14px] h-[14px] text-[#444CE7]" />
            }
